camera_set_view_target(view_camera[lobbyMemberID], playerID);
...
var _camX = x - (_camW/2);
var _camY = y - _camH/2;
var _newCamX = lerp(_camX,(_camX+(xSpeed*45)), 0.05)
camera_set_view_pos(_cam, _newCamX, _camY);

var _cx = camera_get_view_x(view_camera[lobbyMemberID]);
